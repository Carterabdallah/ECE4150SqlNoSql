...
from env import AWS_ACCESS_KEY, AWS_SECRET_ACCESS_KEY, AWS_REGION, PHOTOGALLERY_S3_BUCKET_NAME, DYNAMODB_TABLE, USER_DYNAMODB_TABLE, HASH_SERIALIZER, CURRENT_URL,EMAIL_SOURCE
...
userTable = dynamodb.Table(USER_DYNAMODB_TABLE)
